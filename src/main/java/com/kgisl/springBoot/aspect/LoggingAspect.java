package com.kgisl.springBoot.aspect;
...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.kgisl.springBoot.service.TradesService.*(..))")
    ...
    @After(value = "execution(* com.kgisl.springBoot.service.TradesService.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.kgisl.springBoot.controller.*.*(..))", throwing = "excep")
